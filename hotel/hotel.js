...
const cardWidth = document.querySelector('.image-card').offsetWidth + 
                  parseInt(window.getComputedStyle(document.querySelector('.image-card')).marginLeft) + 
                  parseInt(window.getComputedStyle(document.querySelector('.image-card')).marginRight);
